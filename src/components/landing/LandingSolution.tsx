      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
          <div className="flex flex-col items-center text-center max-w-xs group">
            <div className="w-24 h-24 rounded-full bg-white border border-slate-200 flex items-center justify-center mb-6 shadow-lg relative transition-transform group-hover:scale-105 duration-300">
          ...
          <div className="relative flex flex-col items-center text-center max-w-xs z-10">
            <div className="w-32 h-32 rounded-full bg-slate-900 border-4 border-white shadow-2xl flex items-center justify-center mb-8 relative">
          ...
          <div className="flex flex-col items-center text-center max-w-xs group">
            <div className="w-24 h-24 rounded-full bg-white border border-slate-200 flex items-center justify-center mb-6 shadow-lg transition-transform group-hover:scale-105 duration-300">
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
          {[
